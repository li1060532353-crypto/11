  ...
  return (
    <>
      ...
      <Container className="about-page">
        <section className="about-page__statement" aria-labelledby="about-introduction-title">
          <h2 id="about-introduction-title">自我介绍</h2>
          <p>{about.summary}</p>
          <p>我把学习中的推导、实验和复盘整理成可以持续验证的工程笔记。</p>
        </section>
        <div className="about-page__details">
          <section className="about-page__detail" aria-labelledby="about-focus-title">
          ...
          <section className="about-page__detail" aria-labelledby="about-contact-title">
