...
3. In Workers & Pages > the Pages project > Settings > Bindings, add the D1 database as `DB` and R2 bucket as `ASSETS` for both Production and Preview. Redeploy after each binding change.
